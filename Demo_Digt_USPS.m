        ...
        for rho = [1]
            ...
            for lambda = [9:1:15]
                ...
                elseif strcmp(SegmentationMethod, 'DANNLSR') == 1 || strcmp(SegmentationMethod, 'DANPLSR') == 1
                    matname = sprintf([write_results_dir dataset '_' num2str(nSample(1)) '_' num2str(nExperiment) '_' SegmentationMethod '_DR' num2str(DR) '_dim' num2str(dim) '_maxIter' num2str(Par.maxIter) '_rho' num2str(Par.rho) '_lambda' num2str(Par.lambda) '_s' num2str(Par.s) '.mat']);
                    save(matname,'missrate','avgmissrate','medmissrate');
